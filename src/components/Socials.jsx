    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          <path d="M4 5h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2zm0 2v.4l8 4.8 8-4.8V7H4zm16 10V9.6l-8 4.8-8-4.8V17h16z" />
        </svg>
      ),
    },
  ];
      ...
      {socials.map((s) => {
        ...
        return (
          <a
            ...
            className="hover:text-white transition cursor-pointer flex items-center text-neutral-400"
            aria-label={s.name}
          >
            {s.icon}
          </a>
